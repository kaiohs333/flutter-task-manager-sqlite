...
class CameraService {
  ...
  Future<String?> takePicture(BuildContext context) async {
    ...
    final camera = _cameras!.first; // Usa a primeira câmera encontrada (geralmente a traseira)
    ...
    try {
      ...
      // Navega para a tela de câmera em tela cheia
      ...
      controller.dispose(); // Libera o recurso da câmera ao sair da tela
    }
  }
  ...
  Future<String> savePicture(XFile image) async {
    try {
      ...
      // Cria uma pasta 'images' se ela não existir
